                      ...
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return (index + 1 <=
                                      widget
                                          .accelerometer.distanceRecords.length)
                                  ? Card(
                                      child: ListTile(
                                        isThreeLine: true,
                                        leading: Icon(
                                        ...
                                        subtitle: Column(
                                          children: [
                                            ...
                                            Text(
                                              '[x: ${widget.accelerometer.dataPoints[index]['x'].substring(0, 5)} y: ${widget.accelerometer.dataPoints[index]['y'].substring(0, 5)} z: ${widget.accelerometer.dataPoints[index]['z'].substring(0, 5)}] to [${widget.accelerometer.dataPoints[index + 1]['x'].substring(0, 5)} y: ${widget.accelerometer.dataPoints[index + 1]['y'].substring(0, 5)} z: ${widget.accelerometer.dataPoints[index + 1]['z'].substring(0, 5)}]',
                                              style: const TextStyle(
                                                fontFamily: 'Montserrat',
                                                fontSize: 10.0,
                                                color: Colors.grey,
...
class _Controller {
  ...
  void startTimer() async {
    ...
    collect = Timer.periodic(
      ...
      print(state.widget.database[randNum].xValue);
      print(state.widget.database[randNum].yValue);
      print(state.widget.database[randNum].zValue);
